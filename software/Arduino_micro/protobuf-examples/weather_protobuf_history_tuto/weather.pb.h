...
#define DataHistory_init_default                 {{{NULL}, NULL}}
#define Data_init_zero                           {0, 0, 0, 0, 0}
#define DataHistory_init_zero                    {{{NULL}, NULL}}
...
#define DataHistory_FIELDLIST(X, a) \
X(a, CALLBACK, REPEATED, MESSAGE,  data,              1)
#define DataHistory_CALLBACK pb_default_field_callback
#define DataHistory_DEFAULT NULL
#define DataHistory_data_MSGTYPE Data

extern const pb_msgdesc_t Data_msg;
extern const pb_msgdesc_t DataHistory_msg;

/* Defines for backwards compatibility with code written before nanopb-0.4.0 */
#define Data_fields &Data_msg
#define DataHistory_fields &DataHistory_msg

/* Maximum encoded size of messages (where known) */
/* DataHistory_size depends on runtime parameters */
#define Data_size                                49
